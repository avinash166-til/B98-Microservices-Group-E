...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "mounika.koppala@gmail.com", "mounika", "kopppala", "dharmavaram 671", "8374834562", "Puttaparthi");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "chaitra.kumbara@gamail.com", "chaitra", "kumbara", "banglore 11", "94876348163", "Banglore");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("user", pwEncoder.encode("test"), "megh.kali@gmail.com", "megh", "kali", "ongole 97", "972347222", "Ongole");
			user3.setRole("ROLE_USER");	
			User user4 = new User("avinash", pwEncoder.encode("test"), "avinash.tilavalli@gmail.com", "Avinash", "Tilavalli", "karavar 173", "9476374612", "Karvar");
			User user5 = new User("chandana", pwEncoder.encode("test"), "chandana.basavaraju@gmail.com", "Chandana", "Basavaraju", "Banglore 11", "835745874", "");
